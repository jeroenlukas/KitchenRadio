...
public:
    ...
    void setVolume(uint8_t vol);                // Set the player volume.Level from 0-100,
                                                // higher is louder.
    void setTone(uint16_t value);               // Set the player baas/treble, 4 nibbles for
                                                // treble gain/freq and bass gain/fr
    void setBass(int8_t level);                 // level = - 7..+7                                            
    void setTreble(int8_t level);               // level = - 7..+7
